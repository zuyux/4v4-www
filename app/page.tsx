  ...
  return (
    <>
      <main className="overflow-y-auto">
        {/* Navigation */}
        <header className="mx-auto sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        ...
        <footer className="w-full border-t bg-background py-6 md:py-12">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <p className="text-muted-foreground">
                The hub for avatar creation and exchange, enhancing virtual identity and gaming experiences
              </p>
              <div className="flex gap-4">
                ...
                <Button variant="ghost" size="icon">
                  ...
                  >
                    ...
                    <path d="M6.5 11.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
                  </svg>
                  <span className="sr-only">Discord</span>
                </Button>
              </div>
              <p className="text-sm text-muted-foreground">© 2025 4V4. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </main>
